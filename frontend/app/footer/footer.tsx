...
// Since the component takes no props, we can define it directly.
      ...
      <div className="container mx-auto py-6 px-4">
        <div className="flex flex-col items-center justify-center">
          <p className="text-gray-600 text-center text-lg mb-4">
            ...
            {/* Using legacyBehavior with a nested <a> tag is the correct way 
              to use target="_blank" with Next.js Link. Good job!
            */}
